...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    editarCurso(state, cursoActualizado) {
  ...
  actions: {
    agregarCurso({ commit }, curso) {
      // Realizar validaciones antes de agregar el curso si es necesario
      commit('agregarCurso', curso);
    },
    eliminarCurso({ commit }, cursoId) {
      // Realizar otras acciones necesarias antes de eliminar el curso si es necesario
      commit('eliminarCurso', cursoId);
    },
    editarCurso({ commit }, cursoActualizado) {
      // Realizar validaciones y otras acciones necesarias antes de editar el curso si es necesario
      commit('editarCurso', cursoActualizado);
    },
  },
  modules: {
  }
